    ...
    public static void tampilProduk() throws IOException{
        ...
        if(pil == 1){
            ...
            if (pAnak.isEmpty()){
                ...
                System.out.println("Nama Produk   : " + pAnak.get(i).getNamaProduk());
                System.out.println("stok          : " + pAnak.get(i).getStok_produk());
                System.out.println("gender        : " + pAnak.get(i).getGender());
                System.out.println("harga         : " + pAnak.get(i).getHarga_produk());
                System.out.println("Usia          : " + pAnak.get(i).getUsia());
                System.out.println("Bahan         : " + pAnak.get(i).getBahan());
                    }
                }
                System.out.println("\n-------------------------------------------------");
        }else if(pil == 2){
            ...
            if (pDewasa.isEmpty()){
                ...
                System.out.println("Produk Ke-" + (i));
                System.out.println("Nama Produk   : " + pDewasa.get(i).getNamaProduk());
                System.out.println("stok          : " + pDewasa.get(i).getStok_produk());
                System.out.println("gender        : " + pDewasa.get(i).getGender());
                System.out.println("harga         : " + pDewasa.get(i).getHarga_produk());
                System.out.println("Kategori      : " + pDewasa.get(i).getKategori());
                System.out.println("Size Chart    : " + pDewasa.get(i).getSize_chart()); 
                }
            }
                System.out.println("\n-------------------------------------------------");
        }else{
